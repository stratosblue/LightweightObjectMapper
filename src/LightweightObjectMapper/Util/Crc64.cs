...
{
    // see https://github.com/dotnet/runtime/blob/main/src/libraries/System.IO.Hashing/src/System/IO/Hashing/Crc64.cs
    ...
    public static ulong HashToUInt64(byte[] source)
    {
        ulong crc = 0;
