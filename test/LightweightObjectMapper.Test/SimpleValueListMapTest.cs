...
[TestClass]
public class SimpleValueListMapTest : ObjectMapTestBase
{
    #region Public 方法
    ...
    {
        var a = new SimpleValueListClass1()
        {
        ...
        var b = a.MapTo<SimpleValueListClass2>();
        AssertEquals(a, b);
        ...
        var c = b.MapTo<SimpleValueListClass2>();
        AssertEquals(a, c);
    ...
    private static void AssertEquals(SimpleValueListClass1 a, SimpleValueListClass2 b)
    {
