...
[TestClass]
public class InheritClassMapTest : ObjectMapTestBase
{
    #region Public 方法
    ...
    {
        var a = new InheritClassMapClass1()
        {
        ...
        var b = a.MapTo<InheritClassMapClass2>();
        AssertEquals(a, b);
        ...
        var c = b.MapTo<InheritClassMapClass2>();
        AssertEquals(a, c);
    ...
    private static void AssertEquals(InheritClassMapClass1 a, InheritClassMapClass2 b)
    {
