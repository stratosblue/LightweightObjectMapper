...
[TestClass]
public class SimpleClassFieldMapTest : ObjectMapTestBase
{
    #region Public 方法
    ...
    {
        var a = new SimpleClassFieldMapClass1()
        {
        ...
        var b = a.MapTo<SimpleClassFieldMapClass2>();
        AssertEquals(a, b);
        ...
        var c = b.MapTo<SimpleClassFieldMapClass2>();
        AssertEquals(a, c);
    ...
    private static void AssertEquals(SimpleClassFieldMapClass1 a, SimpleClassFieldMapClass2 b)
    {
